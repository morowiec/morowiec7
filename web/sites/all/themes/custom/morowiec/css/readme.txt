...
To use these stylesheets, rename the files and morowiec with the name of your theme.
...
morowiec-alpha-default-narrow.css  
...
morowiec-alpha-default-normal.css
...
morowiec-alpha-default-wide.css
